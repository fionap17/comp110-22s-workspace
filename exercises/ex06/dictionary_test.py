...
def test_invert() -> None:
    ...
    assert invert(test_dict) == {"a": "A", "b": "B", "c": "C", "d": "D"}
...
def test_invert_words_and_characters() -> None:
    ...
    assert invert(test_dict) == {"dogs": "cats", "three": "1", "trial": "away", "d": "T"}


def test_invert_raise_key_error() -> None:
    """Tests invert function when a key is duplicated in dictionary."""
...
def test_favorite_color_no_fav() -> None:
    ...
    assert favorite_color(survey) == "blue"
...
def test_count_no_repeats() -> None:
    ...
    assert count(sentence) == {"the": 1, "cat": 1, "and": 1, "mouse": 1, "dog": 1, "are": 1, "friends": 1}
...
def test_count_various_counts() -> None:
    ...
    assert count(sentence) == {"the": 4, "cat": 3, "and": 1, "dog": 2, "are": 1, "friends": 1}